...
htmlhelp_basename = 'RecServerdoc'
...
latex_documents = [
    (master_doc, 'RecServer.tex', 'RecServer Documentation',
     'Carlos A. Segura Cerna & Michael D. Ekstrand', 'manual'),
]
...
man_pages = [
    (master_doc, 'RecServer', 'RecServer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RecServer', 'RecServer Documentation',
     author, 'RecServer', 'One line description of project.',
     'Miscellaneous'),
]
